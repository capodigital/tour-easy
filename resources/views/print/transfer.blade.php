<article>
    ...
    <div style="position: relative; margin-bottom: .25rem">
        <div style="padding-left: 2rem">
            <p style="color: #000; font-weight: bold; font-size: 1.05em">Lugar de partida</p>
    ...
    <div style="position: relative; margin-bottom: .25rem">
        <div style="padding-left: 2rem">
            <p style="color: #000; font-weight: bold; font-size: 1.05em">Lugar de llegada</p>
            <p style="color: #474747;font-size:.9em">{{ $activity->name }}</p>
        </div>
    </div>
    <span
