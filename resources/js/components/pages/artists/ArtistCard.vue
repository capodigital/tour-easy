...
<template>
    <div class="bg-white rounded-2xl shadow-md shadow-gray-500 p-3 transition-all hover:scale-105 cursor-pointer relative pb-12">
        <div class="">
            ...
            <div class="min-h-[3.5rem]">
                <h3 class="font-bold text-lg text-gray-900">{{ artist.name }} {{ artist.lastname }}</h3>
                <p class="text-gray-500 text-sm leading-4 pe-10">{{ artist.stagename }}</p>
            </div>
            <p class="text-sm">{{ artist.notes }}</p>
        </div>
