    ...
    <article
        ...
        <div class="">
            ...
            <div class="min-h-[3.5rem]">
                <h3 class="font-bold text-lg text-gray-200">{{ contact.name }}</h3>
                <p class="text-gray-300 text-sm leading-4 pe-10">{{ contact.typecontact.description }}</p>
            </div>
            <p class="text-xs text-gray-400">{{ contact.notes }}</p>
        </div>
