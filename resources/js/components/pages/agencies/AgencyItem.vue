...
<template>
    <div
        class="bg-gradient-to-tr from-slate-700 max-w-[100vw-2rem] overflow-hidden to-slate-950 rounded-2xl shadow-md shadow-gray-500 transition-all hover:scale-105 cursor-pointer">
        <div class="">
                ...
                <div class="grid grid-cols-1 gap-x-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">{{ agency.city.name }} ({{ agency.city.name }})</p>
                        </div>
                    </div>
                </div>
                <hr class="my-2 border-gray-500" />
