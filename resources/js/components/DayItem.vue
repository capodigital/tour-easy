...
<template>
    <article class="bg-gradient-to-tr rounded-lg from-slate-800 via-slate-900 to-slate-950 mb-2 max-w-3xl">
        <div class="flex items-center w-full">
            <div class="p-2 w-11/12 flex items-center">
                ...
                <div class="w-full">
                    ...
                    <p class="text-white text-sm" v-html="activity.description"></p>
                </div>
            </div>
            ...
            <div class="flex items-center w-full">
                <div class="flex items-center mt-2">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-sm">{{ Utils.time(activity.startdate, Utils.FULL_TIME) }}</p>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center mt-2">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 text-sm">{{ Utils.time(activity.enddate, Utils.FULL_TIME) }}</p>
                    </div>
                </div>
            </div>
            <hr class="my-2 border-gray-500" />
