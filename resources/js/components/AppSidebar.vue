...
<template>
    <aside class="hidden md:block w-2/12 h-[calc(100vh-4rem)] shadow-lg shadow-gray-600 bg-white relative">
        ...
        <div class="ps-3">
            ...
            <a class="transition-all py-3 flex items-center" @click="active = -2" href="#calendar"
            ...
            <a class="transition-all py-3 flex items-center" @click="active = -1" href="#artists"
            ...
            <a class="transition-all py-3 flex items-center" @click="active = 2" href="#agencies"
            ...
            <a class="transition-all py-3 flex items-center" @click="active = 1" href="#tickets"
                :class="{ 'text-gray-500': active != 1, 'text-black': active == 1 }">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <a v-if="Utils.role() != 'artist'" class="transition-all py-3 flex items-center" @click="active = -2"
                href="#places" :class="{ 'text-gray-500': active != -2, 'text-black': active == -3 }">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <a v-if="Utils.role() != 'artist'" class="transition-all py-3 flex items-center" @click="active = 3"
                href="#personal" :class="{ 'text-gray-500': active != 3, 'text-black': active == 3 }">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    :stroke="active == 3 ? '#000' : '#6b7280'" stroke-width="2" stroke-linecap="round"
