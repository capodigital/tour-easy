...
<template>
    <div>
        <div class="grid grid-cols-2 gap-x-2">
            <div>
                <label class="text-slate-200 text-xs font-semibold">Nombre del itinerario</label>
        ...
        <div class="grid grid-cols-2 gap-x-2 my-2">
            <div>
                <label class="text-slate-200 text-xs font-semibold">Carrier</label>
                <div class="flex items-center mb-3 rounded border border-gray-300 px-2">
                    <i class="bi bi-envelope text-gray-100"></i>
                    <input required v-model="activity.carrier" name="carrier" type="text" placeholder="Carrier"
                        class="bg-transparent w-full text-gray-300 text-sm border-none focus:outline-none px-3 py-3">
                </div>
            </div>
            <div>
                <label class="text-slate-200 text-xs font-semibold">Carrier Id</label>
                <div class="flex items-center mb-3 rounded border border-gray-300 px-2">
                    <i class="bi bi-envelope text-gray-100"></i>
                    <input required v-model="activity.carrier_id" name="carrier_id" type="text" placeholder="Carrier Id"
                        class="bg-transparent w-full text-gray-300 text-sm border-none focus:outline-none px-3 py-3">
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-x-2">
            <div>
                <label class="text-slate-200 text-xs font-semibold">País de partida</label>
                <div class="flex items-center mb-3 rounded border border-gray-300 px-2">
            ...
            <div>
                <label class="text-slate-200 text-xs font-semibold">País de llegada</label>
                <div class="flex items-center mb-3 rounded border border-gray-300 px-2">
                    <i class="bi bi-globe text-gray-100"></i>
                    <select required v-model="activity._country_end"
                        @change="(e) => $emit('updatecities', { code: e.target.value, type: 'end' })"
                        class="bg-transparent w-full text-gray-300 text-sm border-none focus:outline-none px-3 py-3">
                        <option class="text-black" v-for="country in countries" :value="country.code">{{
                            country.name }}</option>
                    </select>
        ...
        <div class="grid grid-cols-2 gap-x-2">
            <div>
                <label class="text-slate-200 text-xs font-semibold">Ciudad de partida</label>
                <div class="flex items-center mb-3 rounded border border-gray-300 px-2">
            ...
            <div>
                <label class="text-slate-200 text-xs font-semibold">Ciudad de llegada</label>
                <div class="flex items-center mb-3 rounded border border-gray-300 px-2">
                    <i class="bi bi-globe-americas text-gray-100"></i>
        ...
        <div class="grid grid-cols-2 gap-x-2">
            <div>
                ...
                <MultiSelect :ids="persons_1" label="Seleccionar contactos" :options="contacts" :initial="activity.persons_1">
