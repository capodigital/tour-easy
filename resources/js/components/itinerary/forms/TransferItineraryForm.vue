...
<template>
    <div>
        ...
        <div class="grid grid-cols-2 gap-x-2">
            <div>
                <label class="text-slate-200 text-xs font-semibold">Lugar de salida</label>
                <div class="flex items-center rounded border border-gray-300 px-2">
            ...
            <div>
                <label class="text-slate-200 text-xs font-semibold">Lugar de llegada</label>
                <div class="flex items-center rounded border border-gray-300 px-2">
                    <select required v-model="activity.name" name="name"
                        class="bg-transparent w-full text-gray-300 text-sm border-none focus:outline-none px-3 py-3">
                        <template v-for="item in places">
                            <option v-if="Utils.place(item, activity.typeitinerary_id)" class="text-black"
                                :value="item.name">
                                {{ item.name }}
                            </option>
                        </template>
