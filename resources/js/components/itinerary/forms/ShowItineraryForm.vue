...
<template>
    <div>
        <div class="grid grid-cols-2 gap-x-2">
            <div>
                <label class="text-slate-200 text-xs font-semibold">Evento/Festival</label>
                <div class="flex items-center mb-3 rounded border border-gray-300 px-2">
                    <i class="bi bi-envelope text-gray-100"></i>
                    <input required v-model="activity.name" name="name" type="text" placeholder="Evento/Festival"
                        class="bg-transparent w-full text-gray-300 text-sm border-none focus:outline-none px-3 py-3">
                </div>
            </div>
            <div>
                <label class="text-slate-200 text-xs font-semibold">Recinto</label>
        ...
        <div class="grid grid-cols-2 gap-x-2 my-3">
            ...
            <div>
                <label class="text-slate-200 text-xs font-semibold">Apertura de puertas</label>
                <div class="flex items-center mb-3 rounded border border-gray-300 px-2">
                    <i class="bi bi-calendar-day text-gray-100"></i>
        ...
        <div class="grid grid-cols-2 gap-x-2">
            <div>
                <label class="text-slate-200 text-xs font-semibold">Fecha y hora del show</label>
                <div class="flex">
            ...
            <div>
                <label class="text-slate-200 text-xs font-semibold">Fecha y hora de fin del show</label>
                <div class="flex">
                    <div class="flex items-center mb-3 rounded border border-gray-300 px-2 me-1 w-1/2">
                        <i class="bi bi-calendar-day text-gray-100"></i>
