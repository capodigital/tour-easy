...
<template>
    <div>
        <nav
            class="w-screen z-50 flex justify-between p-4 items-center lg:px-20 bg-white fixed top-0 left-0 overflow-hidden shadow-lg shadow-gray-200">
            ...
            <button @click="collapse = !collapse" class="md:hidden">
